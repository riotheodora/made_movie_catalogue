...
public class MyWatchlistWidget extends AppWidgetProvider {
    ...
    private void updateAppWidget(Context context, AppWidgetManager appWidgetManager,
        ...
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.my_watchlist_widget);
        views.setRemoteAdapter(R.id.stack_view, intent);
        views.setEmptyView(R.id.stack_view, R.id.empty_view);

        Intent toastIntent = new Intent(context, MyWatchlistWidget.class);

        toastIntent.setAction(MyWatchlistWidget.TOAST_ACTION);
